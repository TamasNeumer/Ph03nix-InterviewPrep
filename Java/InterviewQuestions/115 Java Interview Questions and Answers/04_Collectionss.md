# Java Collection (Framework) and Collections utility class
...
The 3 methods of the Iterator interface are:
- `hasNext()`, `remove()`, `next()`
...
#### 31. What is the trade-off between using an unordered array versus an ordered array ?
